-- =============================================
-- MEXO Forms V11: Authoritative Auth Session & Submission RPC
-- =============================================

-- Ensure submit_form_response handles session checks cleanly and atomically
...
DECLARE
  ...
  v_existing_ref TEXT;
BEGIN
  -- 1. Single Source of Truth Authentication Check
  v_user_id := auth.uid();
