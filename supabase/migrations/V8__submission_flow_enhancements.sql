-- =============================================
-- MEXO Forms V8: Submission Flow Enhancements & Idempotency
-- =============================================

-- 1. Add idempotency_key to public.form_responses
ALTER TABLE public.form_responses
  ADD COLUMN IF NOT EXISTS idempotency_key UUID DEFAULT NULL;

CREATE UNIQUE INDEX IF NOT EXISTS idx_form_responses_idempotency_key
  ON public.form_responses(idempotency_key)
  WHERE idempotency_key IS NOT NULL;

-- 2. Enhanced Atomic Submission RPC with Idempotency Key & JSON Return
...
BEGIN
  ...
  -- Resolve respondent email/primary_address
...
GRANT EXECUTE ON FUNCTION public.submit_form_response(UUID, JSONB, TIMESTAMPTZ, INTEGER, TEXT, UUID)
