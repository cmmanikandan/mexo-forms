...
import {
  ...
  MessageCircle, Send, Globe, GraduationCap, Sparkles, AlertCircle,
} from 'lucide-react';
    ...
    <AppShell>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          {/* Left Column: Link, Quick Share, Embed */}
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="p-4 rounded-2xl bg-amber-50/80 border border-amber-200 flex items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-xl bg-amber-500/20 flex items-center justify-center text-amber-700">
